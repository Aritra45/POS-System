...
const handleSubmit = async(value) => {
    try {
        ...
        if (inputValue.length > 10) {
            message.warning('Contact Number Will be 10 Digits Only!');
          } else {
...
const clearCart = () => {
  ...
  return (
    <DefaultLayout>
        ...
        <Input type="Number" value={inputValue} onChange={handleInputChange} maxLength={10} placeholder='10 Digits Number' required />
        </Form.Item> 
